...
def main():
    ...
    parser.add_argument('--tracker_name', type=str, default='RLT_dimp', help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default='new', help='Name of parameter file.') # dimp18, dimp18_vot, dimp50, dimp50_vot, dimp50_vot19, prdimp18, prdimp50, super_dimp
