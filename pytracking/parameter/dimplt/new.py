...
def parameters():
    ...
    params.save_sample_interval = 1 # save memory interval
    ...
    params.no_update_early_redetection = 0 # no update period after re-detection success
    ...
    params.track_net_more_learn = False # more discriminative learning (track)
    ...
    params.additional_train_candidate = 1 # number of additional samples
    ...
    params.erasing_mode = False # Random erasing (RE) mode when tracking
    ...
    params.lower_ratio = 0.3 # RE parameters
    params.upper_ratio = 3.3 # RE parameters
