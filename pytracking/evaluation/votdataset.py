...
class VOTDataset(BaseDataset):
    ...
    def _get_sequence_list(self): # [[[VOTLT2020]]]
        sequence_list= [
                        'ballet', # [57]
                        'bicycle', # [72] ** need distance penalty when re-detect **
                        'bike1', # [85]
                        'bird1', # [10] ** need global re-detection **
                        'boat', # [49]
                        'bull', # [77] ** need to relax background distractor **
                        'car1', # [55] ** consider negative object distractor **
                        'car3', # [76]
                        'car6', # [84]
                        'car8', # [88]
                        'car9', # [77]
                        ...
                        'carchase', # [58]
                        'cat1', # [77]
                        'cat2', # [34] ** consider negative object distractor **
                        'deer', # [70]
                        'dog', # [45] ** just difficult **
                        'dragon', # [49] ** consider negative object distractor **
                        'f1', # [81]
                        'following', # [69]
                        'freesbiedog', # [70]
                        'freestyle', # [78]
                        'group1', # [70]
                        'group2', # [3] ** consider negative object distractor **
                        'group3', # [61]
                        'helicopter', # [44] **
                        'horseride', # [73]
                        'kitesurfing', # [67]
