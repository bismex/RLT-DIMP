...
class Tracker:
    ...
    def run_vot2020(self, debug=None, visdom_info=None, dataset_path=None):
        params = self.get_parameters()
        params.tracker_name = self.name
        params.param_name = self.parameter_name
    ...
    def run_vot2020_LT(self, debug=None, visdom_info=None, dataset_path=None):
        params = self.get_parameters()
        params.tracker_name = self.name
        params.param_name = self.parameter_name
        params.run_id = self.run_id
        ...
        while True:
            ...
            confidence = out['confidence'] if 'confidence' in out else 1.0
            handle.report(pred, confidence)
