...
def main():
    ...
    # parser.add_argument('--experiment_name', type=str, default = 'vot_lt_2020_all_test', help='Name of the experiment function.')
    parser.add_argument('--experiment_name', type=str, default = 'vot_lt_2020_local3', help='Name of the experiment function.')
